...
string validIPAddress(string queryIP){
    ...
    if(queryIP.find(".", start) != -1){
       ...
       // deli = ":";
       cout << queryIP.find_first_not_of("abcdefABCDEF1234567890") <<endl;
       if(!isdigit(queryIP[queryIP.length() - 1]) || queryIP.find_first_not_of("abcdefABCDEF1234567890") != string::npos)
             return "Neither";
        cout << "start" <<endl;
       queryIP += ":";
       string temp = "";
